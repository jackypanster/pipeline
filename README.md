...
| pipeline-preflight | (helper script, not a stage) | deterministic executor of shim steps 1/3/4 + the stale-dispatch guard; stage skills call `scripts/preflight.sh` at step 0 — never invoke by hand |
